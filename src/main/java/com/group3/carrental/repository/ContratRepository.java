...
public interface ContratRepository extends JpaRepository<Contrat, Long> {
    ...
    Optional<Contrat> findByIdAndLoueurIdAndStatutAndDateFinBefore(Long id, int loueurId, Contrat.Statut statut, Date date);
    Optional<Contrat> findByIdAndAgentIdAndStatutAndDateFinBefore(Long id, int agentId, Contrat.Statut statut, Date date);
}
